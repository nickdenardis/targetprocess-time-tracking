...
var attachEntity = function () {
  ...
  div.setAttribute('data-item', JSON.stringify({'id':entity_id.replace(/\D/g,''),'name':entity_id + ' ' + entity_title}));
...
var css = '#harvest-iframe-container { z-index: 999999 !important; }',
